...
const botSay = (data) => {
    return [
        "Perkenalkan Nama Saya CristianBot. Siapa Nama Kamu?",
...
function finishing() {
    pertanyaan.innerHTML = `Thank u ya ${usersData[0]} udah main ke cristianbot 😁, next time kita ${usersData[2]} bareng ya!`
    jawaban.value = "Oke,siap makasih!"
}
